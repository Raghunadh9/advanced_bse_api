...
import { allDataArrayInterFace, allDataInterFace } from "@/types";
...
const HomePage = async () => {
  ...
  const allData: AllDataProps = await fetchAllData();
            ...
            return (
              <tbody key={index}>
                <tr className="border border-black ">
                  ...
                  <td className="border border-black p-2 ">{i.LONG_NAME}</td>
                  ...
                  <td className="border border-black p-2 underline text-blue-500">
                    {" "}
                    <a
                      href={`https://www.google.com/search?q=zauba+${i.LONG_NAME}`}
                      target="_blank"
                  ...
                  <td className="border border-black p-2 underline text-blue-500">
                    {" "}
                    <a
                      href={`https://www.google.com/search?q=moneycontrol+${i.LONG_NAME}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      M.C
                  ...
                  <td className="border border-black p-2 underline text-blue-500">
                    <a
                      href={`https://advancedastra.onrender.com/${i.LONG_NAME}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      N
